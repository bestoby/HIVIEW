...
/*maohw static*/ ext_data_type_t g_mipi_ext_data_type_os08a20_12bit_8m_nowdr_attr = {
    .devno = 0,
    .num = MIPI_NUM,
...
/*maohw static*/ combo_dev_attr_t g_mipi_4lane_chn0_sensor_os08a20_12bit_8m_nowdr_attr = {
    .devno = 0,
...
/*maohw static*/ combo_dev_attr_t g_mipi_4lane_chn0_sensor_os08a20_12bit_8m_nowdr_dev2_attr = {
    .devno = 2, /* dev2 */
    .input_mode = INPUT_MODE_MIPI,
    .data_rate  = MIPI_DATA_RATE_X1,
    .img_rect   = {0, 0, WIDTH_3840, HEIGHT_2160},
...
static hi_s32 sample_comm_vi_start_chn(hi_vi_pipe vi_pipe, const sample_vi_pipe_info *pipe_info)
{
    hi_u32 i;
    hi_s32 ret;
    hi_s32 chn_num = pipe_info->chn_num;
