...
typedef enum {
    ...
    PIC_7680X4320,
    PIC_3840X8640,
    #define HAVE_PIC_6000P
    PIC_8000X6000,
    #define HAVE_PIC_2048P
    PIC_2448X2048,
    PIC_BUTT
} hi_pic_size;
...
enum {
    ...
    PIC_8000x6000 = PIC_8000X6000,
    PIC_2448x2048 = PIC_2448X2048,
};
...
typedef enum {
    ...
    MIPI_YUV422_2M_60FPS_8BIT,		 //yuv422cam
    ...
    MIPI_YUV422_2M_30FPS_8BIT_6CH,	//yuv422ahd	
    ...
    SONY_IMX678_MIPI_8M_30FPS_10BIT_WDR2TO1,
    SONY_IMX678_MIPI_8M_60FPS_10BIT, 
    SONY_IMX678_MIPI_2M_25FPS_12BIT,
    SONY_IMX662_MIPI_2M_30FPS_12BIT,
    MIPI_YUV422_0M_60FPS_8BIT,  //yuv422th640
    MIPI_YUV422_1M_30FPS_8BIT,  //yuv422th1280
    SONY_IMX664_2L_MIPI_4M_30FPS_12BIT,
    SONY_IMX568_MIPI_5M_30FPS_12BIT,
    SNS_TYPE_BUTT,
} sample_sns_type;
